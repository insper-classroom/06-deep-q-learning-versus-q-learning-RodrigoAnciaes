...
class DeepQLearning:
    ...
    def __init__(self, env, gamma, epsilon, epsilon_min, epsilon_dec, episodes, batch_size, memory, model, max_steps, target_model=None):
        self.env = env
        self.gamma = gamma
    ...
    def experience_replay(self):
        ...
        if len(self.memory) > self.batch_size:
            ...
            targets_full = self.model.predict_on_batch(states) # essa linha esta esquisita
